...
//  Fluffy
//
//  Created by Ирина Дьякова on 17/03/2019.
...
extension UIColor {
    ...
    static let facebook = UIColor(rgb: 0x4e5f93)
    static let vk = UIColor(rgb: 0x555e65)
    static let twitter = UIColor(rgb: 0x8aadd3)
    static let google = UIColor(rgb: 0xad5144)
    static let rasberryBtn = UIColor(red: 192/255, green: 81/255, blue: 248/255, alpha: 1)
    static let blueBtn = UIColor(red: 107/255, green: 129/255, blue: 251/255, alpha: 1)
}
